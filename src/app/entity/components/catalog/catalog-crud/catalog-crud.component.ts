...
export class CatalogCrudComponent implements OnInit {
  ...
  onCreate() {
    if (this.form.valid) {
      ...
      //Succes
      let succesMessage = "Nuevo catálogo: " + this.catalog.name;
  ...
  onUpdate() {
    ...
    if (this.form.valid) {
      ...
      //Succes
      let succesMessage = "Actualización de catálogo: " + this.catalog.name;
      this.openSnackBar(succesMessage, "X", "snackbar-success");
    } else {
      //Error
      let errorMessage = "¡Formulario inválido, " + this.validateForm() + "!";
  ...
  onDelete() {
    ...
    //Succes
    let succesMessage = "Se eliminó el catálogo: " + this.catalog.name;
    this.openSnackBar(succesMessage, "X", "snackbar-success");
  }
